...
def get_all_routes(app: falcon.asgi.App):
    routes_list = []

    def get_children(node: falcon.routing.compiled.CompiledRouterNode):
...
# async def init(app: falcon.asgi.App) -> None:
#     """
